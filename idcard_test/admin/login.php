<?php
/**
 * UBIDS Student ID Card Photo Portal - Admin Login
 */
...
<head>
    ...
    <title>Admin Login - <?php echo h(APP_NAME); ?></title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                ...
                <h1 class="display-font text-3xl font-bold text-white mb-2">Admin Portal</h1>
                <p class="text-gray-300">UBIDS ID Card System</p>
            </div>
            ...
            <!-- Login Form -->
            <form class="mt-8 space-y-6 bg-gray-800 rounded-xl p-8 shadow-xl" action="login.php" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="username" name="username" type="text" required
                               class="appearance-none relative block w-full px-3 py-2 border border-gray-600 placeholder-gray-400 text-white bg-gray-700 rounded-lg focus:outline-none focus:ring-yellow-400 focus:border-yellow-400 focus:z-10 sm:text-sm"
                ...
                <div>
                    <button type="submit" 
                            class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-yellow-500 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-400 transition-colors">
                        <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                            <svg class="h-5 w-5 text-yellow-400 group-hover:text-yellow-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="text-center">
                <p class="text-sm text-gray-400">
                    Are you a student? 
                    <a href="../login.php" class="font-medium text-yellow-400 hover:text-yellow-300">Student Login</a>
                </p>
            </div>
            ...
            <div class="mt-8 border-t border-gray-700 pt-6">
                <div class="text-center">
                    <h3 class="text-sm font-medium text-gray-300 mb-2">Need Help?</h3>
                    <p class="text-xs text-gray-400 mb-3">Contact the IT Department for assistance</p>
